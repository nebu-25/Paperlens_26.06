...
- 랜딩 페이지는 PaperLens.html 시안과 동일한 디자인(sticky nav, 제품 목업이 포함된 히어로, 트러스트 스탯 스트립, 경쟁 분석 밴드, 3-pass·목적 템플릿·기능 카드 섹션)을 React로 이식한 서비스 소개 화면입니다. 요금 섹션은 과금 범위 밖이라 포함하지 않습니다.
